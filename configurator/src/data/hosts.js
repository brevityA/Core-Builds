...
export const HOST_META = {
  ...
  //
  // Re-audited 2026-09-17. The registry is an offline fallback only: hosts
  // upgrade independently and a successful live /api/v1/status probe wins.
  // 2.34.1 became the pinned stable contract on 2026-09-26; the five hosts
  // observed on that release can now be represented truthfully in the picker.
