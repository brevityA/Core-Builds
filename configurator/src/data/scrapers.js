export const OPTIONAL_SCRAPER_DEFS = [
  ...
  { id:'debridio-tmdb', label:'Debridio TMDB', desc:'TMDB catalogs via Debridio · meta catalogs', presetType:'debridio-tmdb', cat:'catalog', color:'#fde047' },
  { id:'debridio-tvdb', label:'Debridio TVDB', desc:'TVDB catalogs via Debridio · meta catalogs', presetType:'debridio-tvdb', cat:'catalog', color:'#86efac' },
  { id:'debridio-watchtower', label:'Debridio Watchtower', desc:'HTTP stream provider via Debridio · debrid/http', presetType:'debridio-watchtower', cat:'debrid', color:'#7dd3fc' },
