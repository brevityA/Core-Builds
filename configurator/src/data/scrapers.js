export const OPTIONAL_SCRAPER_DEFS = [
  ...
  { id:'nzbhydra', label:'NZBHydra2', desc:'Self-hosted Usenet aggregator — one URL for all your indexers', presetType:'nzbhydra', cat:'usenet', color:'#10b981', credKey:'nzbhydraApiKey', urlKey:'nzbhydra' },
