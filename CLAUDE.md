...
## Active Template Inventory (as of v3.3.0)

### Single (TorBox Pro)
- `Single/core-nexus-4k-apex.json` v0.8.1 — flagship 4K, IQR PSEs, pow() decay, 5s dynamic fetching cap, Score IQR Guard, elite group pins, perGroup() Extra Cached
