...
LQ streams remain excluded via the `syncedExcludedRegexUrls` list. WEB-DL releases retain ranking via the generic `Web T1` tier. Release group scoring preserved through Remux, Bluray, Anime, and group-specific tiers.
