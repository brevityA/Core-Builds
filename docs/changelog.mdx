...
| [v3.2.9](https://github.com/brevityA/Core-Builds/blob/main/CHANGELOG.md#329) | 2026-07-15 | Template Migration Tool (Configurator v2.49) — "Update Existing Template" now shows a full visual diff of every change (… |
| [v3.2.8](https://github.com/brevityA/Core-Builds/blob/main/CHANGELOG.md#328) | 2026-07-15 | REMUX ranking fix (all 44 active templates) — BluRay REMUX files were consistently ranked below WEB-DL streams because t… |
