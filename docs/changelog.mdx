...
| --- | --- | --- |
| [v3.8.0](https://github.com/brevityA/Core-Builds/blob/main/CHANGELOG.md#380) | 2026-09-22 | Dead-key purge across all 55 active templates — maxResults, maxResultsPerResolution, seadexBestOnly, excludedStreamSourc… |
| [v3.7.0](https://github.com/brevityA/Core-Builds/blob/main/CHANGELOG.md#370) | 2026-09-05 | Standalone template regex sync (drift-fix release) — every active standalone template's inline rankedRegexPatterns, pref… |
| [v3.6.2](https://github.com/brevityA/Core-Builds/blob/main/CHANGELOG.md#362) | 2026-08-22 | Core Badge Builder (Configurator v2.97 · tools/badges/) — a no-code Nuvio Fusion badge configurator with 111 original Co… |
