...
## Add visual stream badges

Nuvio can display image-backed badges for resolution, quality, HDR, audio, codecs, release tiers, languages, and more. The [Core Badge Builder](/nuvio-badges) lets you choose and preview them without writing regex or editing JSON.

<Card title="Build Nuvio stream badges" icon="tag" href="https://brevitya.github.io/Core-Builds/tools/badges/">
  Create a Universal pack or an AIO Enhanced pack with a matching companion formatter.
</Card>
