...
All hard kills remain active in Lite: CAM/SCR exclusion, YouTube and external stream blocking, foreign language filtering, season pack management, resolution enforcement (1080p templates still block 4K), bad NZB filtering, and all regex score filtering.
