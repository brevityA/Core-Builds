...
## Configurator v2.88 (Aug 2 2026)

<CardGroup cols={2}>
  <Card title="Account Manager promoted to available" icon="sparkles">
    tools page card now links directly to the Account Manager
  </Card>
  <Card title="Security: replaced Math.random() with crypto.getRandomValues() for session IDs and account generation (CodeQL #408)" icon="bolt">
