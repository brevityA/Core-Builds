...
- **rseMatched() tier guards** — Bad 4K Anime, Upscaled 4K, Bad 4K Bluray, and Bad 1080P Bluray kills now check ranked regex tiers before firing. If quality-verified groups (BD T1, Remux T1, Web T1, etc.) match, the kill is suppressed.
- **Low Quality w/ No Release Group** — removes low-quality streams (WEBRip, DVDRip, HDTV, CAM, etc.) that have no identifiable release group — catches junk and spam uploads.

See [Nightly and Labs](/nightly-and-labs) for import links.
