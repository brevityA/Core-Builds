...
- Core Line stadium sync: the venue bridge is in `packages/stadium-sync`. The shipping ticker still needs a paired-host allowlist before a raw gym LAN URL will crawl.
