...
<Info>
  **What's new in v2.8.6:** Final regex allowlist fix — 4 `excludedRegexPatterns` with lookbehind/lookahead syntax removed from all 33 active templates. Coverage retained via `rankedRegexPatterns` (Extras −200, Sing-Along −75, BR-DISK −75). Re-import to clear any remaining "regexes not allowed" errors on elfhosted.
</Info>
