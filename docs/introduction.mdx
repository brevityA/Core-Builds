...
<div style={{ maxWidth: '680px', margin: '0 auto', padding: '16px 24px 0', textAlign: 'center' }}>
  ...
  <div style={{ display: 'flex', background: '#0f172a', borderRadius: '12px', border: '1px solid #1e3a5f', overflow: 'hidden', marginBottom: '16px' }}>
    <div style={{ flex: 1, textAlign: 'center', padding: '20px 0', borderRight: '1px solid #1e3a5f' }}>
      <div style={{ fontSize: '28px', fontWeight: '800', color: '#60a5fa' }}>45+</div>
    ...
    <div style={{ flex: 1, textAlign: 'center', padding: '20px 0' }}>
      <div style={{ fontSize: '22px', fontWeight: '800', color: '#60a5fa' }}><a href="/changelog" style={{ color: 'inherit', textDecoration: 'none' }}>v2.9.7</a></div>
