...
<Info>
  **What's new in v2.8.7:** Final elfhosted regex fix — `syncedExcludedRegexUrls` (raw GitHub URL, blocked by elfhosted) removed from all 31 non-Anime templates. The single pattern it contained was already inline. Re-import to fully clear "regexes not allowed" errors.
</Info>
