...
<AccordionGroup>
  <Accordion title="Scraper">
    An AIOStreams addon that searches for streams — Comet, MediaFusion, Knaben, Meteor, etc. Each scraper queries different sources (torrent indexes, debrid caches, Usenet). Core Builds templates configure which scrapers are enabled and their timeouts.
  </Accordion>
